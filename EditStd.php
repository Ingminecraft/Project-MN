...
<?php 
$DS_studentID = $_GET['DS_studentID'];
$sql = "SELECT * FROM dormstudent WHERE DS_studentID=$DS_studentID";
...
<form action="./EditStdProcess.php" method="post">
<tr>
        <td align="center" colspan="2">
        <font size ="+20" color = "black" >
        แก้ไขข้อมูลนิสิตหอพัก<br><br>
        </font>
        </td>
    </tr>
    <tr>
        ...
        <?php if(isset($_SESSION['level'])){if($_SESSION['level']=="A"){
               if($row["DS_right"] == 0){echo 'ระงับการใช้งาน <input type="checkbox" id="Banned" name="Banned" value="1">';}
               if($row["DS_right"] == 1){echo 'ระงับการใช้งาน <input type="checkbox" id="Banned" name="Banned" value="1" checked>';}
              }}
                ?>        
        </td>
    <tr>
        ...
        value=<?php echo $row["DS_fname"];?>></td>
    </tr>
    <tr>
        ...
        value=<?php echo $row["DS_lname"];?>></td>
    </tr>
    <tr>
        ...
        value=<?php echo $row["DS_studentID"];?>></td>
    </tr>
    <tr>
        ...
        value=<?php echo $row["DS_phonenumber"];?>></td>
    </tr>
    <tr>
        <td align="center" bgcolor="" colspan="2">
    ...
    <tr>
        ...
        value=<?php echo $row["DS_password"];?>></td>
    </tr>
    <tr>
        ...
        pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}" 
        title="รหัสต้องมีตัวอักษรอย่างน้อย 8 ตัว ประกอบไปด้วย A-Z, a-z และ 0-9 " required
        value=<?php echo $row["DS_password"];?>></td></td> 
    </tr>
    <tr>
